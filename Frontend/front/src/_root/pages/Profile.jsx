      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center">
          ...
          <div className="relative flex-shrink-0 w-32 h-32">
            <img src={editedProfile.image} alt="Profile" className="w-full h-full rounded-full" />
            {editMode && (
              <input
                type="file"
                accept="image/*"
          ...
          {editMode ? (
            <>
              <input
                ...
                onChange={handleInputChange}
                className="w-20 border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:border-blue-500"
              />
              <input
                type="text"
                name="phone"
