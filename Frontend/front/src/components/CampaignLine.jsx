...
const CampaignLine = ({title, deadline, collection, campaignImage}) => {
  return (
    <div className="flex justify-between items-center mb-2 p-2 text-lg rounded-xl px-4 bg-violet-900 text-white shadow-inner shadow-neutral-800">
      <div className="capitalize w-[100%] mr-2">
    ...
    <div className="w-[120px] lg:w-[154px]">
